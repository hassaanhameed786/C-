...
public:
	...
	//inserting in AVL is same as BST but in this condition of balance 
	void insert(int x, node *&p)
	{
		...
		if (x == p->data)
		{
			cout << x << " node  already present " <<endl;
			return;
		}
		else if (x < p->data)
		{
